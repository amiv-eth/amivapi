...
eventdomain = {'events': {'datasource': {'projection': {'_author': 1,
            ...
            'schema': {'_author': {'data_relation': {'embeddable': False,
                       ...
                       'additional_fields': {'nullable': True,
                                             ...
                                             'type': 'json_schema',
                                             'unique': False},
                       'allow_email_signup': {'default': False,
                                              'required': True,
                                              'type': 'boolean',
                                              'unique': False},
                       ...
                       'price': {'min': 0,
                                 ...
                                 'type': 'integer',
                                 'unique': False},
                       'show_announce': {'default': False,
                                         'nullable': True,
                                         'required': False,
                                         'type': 'boolean',
                                         'unique': False},
                       'show_infoscreen': {'default': False,
                                           'nullable': True,
                                           'required': False,
                                           'type': 'boolean',
                                           'unique': False},
                       'show_website': {'default': False,
                                        'nullable': True,
                                        'required': False,
                                        'type': 'boolean',
                                        'unique': False},
 ...
 'eventsignups': {'datasource': {'projection': {'_author': 1,
                  ...
                  'schema': {'_author': {'data_relation': {'embeddable': False,
                             ...
                             'event': {'data_relation': {'embeddable': True,
                                                         'resource': 'events'},
                                       'type': 'objectid'},
                             'event_id': {'data_relation': {'embeddable': False,
                                                            'resource': 'events'},
                                          'not_patchable': True,
                                          'required': True,
